...
import { DeleteOutline as Delete, ExpandLess, ExpandMore, PersonAdd, EditOutlined as Edit, Search, KeyboardArrowDown, Topic } from "@mui/icons-material";
import { Toaster } from "react-hot-toast";
import { Loader } from "@/components/loader";
import { useDashboard } from "./useDashboard";
import { UserModal } from "./userModal";
import { TopicsTagModal } from "./topicsTagModal";
  ...
  return (
    ...
    {isLoading && <Loader />}
      ...
      {showTopicModal && (
        <TopicsTagModal
          open={showTopicModal}
          setOpen={(isOpen) => setShowTopicModal(isOpen)}
        />
      )}
      <div className="flex justify-between items-center w-full px-6 my-7 sticky top-0 bg-white py-4 shadow-md">
        ...
        <div className="flex gap-10 justify-end items-center">
          ...
          <div>
            ...
            >
              <Topic className="text-white group-hover:text-theme-color" />
            </span>
          </div>
          <div>
            <span
